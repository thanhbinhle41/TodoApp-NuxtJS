export const state = () => ({
  ...
  export const actions = {
    getTodoList(vuexContext) {
      return this.$axios
        .$get('https://61c3da06f1af4a0017d990c2.mockapi.io/todos')
        .then((res) => {
    ...
    addTodo(vuexContext, content) {
      return this.$axios
        .$post('https://61c3da06f1af4a0017d990c2.mockapi.io/todos', {
          content,
          isComplete: false,
        })
        .then(function (res) {
    ...
    editTodo(vuexContext, data) {
      return this.$axios
        .$put(
          `https://61c3da06f1af4a0017d990c2.mockapi.io/todos/${data.todo.id}`,
          {
    ...
    toggleTodo(vuexContext, todo) {
      return this.$axios
        .$put(`https://61c3da06f1af4a0017d990c2.mockapi.io/todos/${todo.id}`, {
    ...
    deleteTodo(vuexContext, todo) {
      return this.$axios
        .$delete(`https://61c3da06f1af4a0017d990c2.mockapi.io/todos/${todo.id}`)
        .then(function (res) {
